...
Graph *grnew(int n, int m, int edgedim) {
  Graph *gp;
...
static void addedge(Graph *gp, int v, int e) {
...
static void deledge(Graph *gp, int v, int e) {
  int eprev, e1;
...
static int degree1(Graph *gp, int v) {
  int e;
...
static void cyclicdeledge(Graph *gp, int v) {
  int i, e;
